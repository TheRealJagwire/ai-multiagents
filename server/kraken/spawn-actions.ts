import { type Effort, type Model, providerOf, type Session, type TeamCoordination } from "../../src/kraken/types.ts";
...
// Sequenced mode: reads the lead's KRAKEN_TASKS.md and spawns one
