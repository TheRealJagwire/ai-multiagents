...
// KRAKEN_TASKS.md). Everything here is pure state mutation — no SDK
// types on either side.

import { planBullets } from "../../src/kraken/format.ts";
...
// lead's KRAKEN_TASKS.md — always lands here: one bulleted card in the
...
// Sequenced-team leads write their plan to KRAKEN_TASKS.md rather than
