...
import { Gemini, InMemorySessionService, LlmAgent, Runner } from "npm:@google/adk@^1.3.0";
...
import { buildCodingTools, settlePendingGates } from "./adk-tools.ts";
    ...
    try {
      const runner = new Runner({
        ...
        agent: new LlmAgent({
          ...
          instruction: WORKER_SYSTEM_PROMPT + ADK_INSTRUCTION_SUFFIX,
          tools,
        }),
        sessionService,
      });
